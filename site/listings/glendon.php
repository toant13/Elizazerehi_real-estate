            	...
            	<div class="single-list">
                	<div class="row" style="border-bottom:1px solid #eeeeee;">
                    	<div class="col-lg-6 left">
                        	<h1>Glendon Ave, <br />Los Angeles 90025 </h1>
                        </div>
                    ...
                    <div id="gallery">
                        <div id="panel">
                            <img id="largeImage1" src="../img/properties/glendon/download (3).jpeg" />
                                ...
                                <div id="feature-carousellist1" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/glendon/download.jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/glendon/download (1).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/glendon/download (2).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/glendon/download (3).jpeg" width="300" alt="">
                                                </li>
                                            </ul>           
                                        </div>
                                        <div class="item">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/glendon/download (4).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                   <img src="../img/properties/glendon/download (5).jpeg" width="300" alt="">
                                                </li>
                    ...
                    <div class="remarks">
                        <div class="row">
                            <div class="col-lg-12">
                                <p><strong>Property: </strong>3 br, 2.5 ba, 1,874ft²</p>
                                <p><strong>Remarks: </strong>PRISTINE PENTHOUSE IN PRIME WESTWOOD, 3 BEDROOM, 2.5 BATH IN A NEWER BUILDING W/ GORGEOUS ARCHITECTURAL DETAILS. GOURMET COOKS KITCHEN, VIKING STAINLESS STEEL APPLIANCES, GRANITE COUNTERS & TOP OF THE LINE CABINETRY. BAMBOO FLOORS, CROWN MOLDINGS, MASTER SUITE W/ DUAL CLOSETS. SPACIOUS LIVING & DINING W/ OPEN FLOOR PLAN & BEAUTIFUL PATIO, PERFECT FOR BBQ OR MORNING COFFEE W/ LARGE STORAGE CLOSETS. CLOSE TO RESTAURANTS & SHOPS ON WESTWOOD BLVD.</p>	
                        ...
                        <div class="row">
                        	<div class="col-lg-6">
                                <p>
                                    <strong>Rooms: </strong>Dining Area,Living,Patio Open,Powder,Other<br />
                                    <strong>Amenities: </strong>Elevator,Security<br />
                                    <strong>Equip: </strong>Cable,Dishwasher,Dryer,Garbage Disposal,Hood Fan,Intercom,Microwave,Range/Oven,Refrigerator,Washer<br />
                                    <strong>Air: </strong>Central<br />
                                    <strong>Floor: </strong>Carpet,Hardwood,Marble,Mixed,Stone,Other<br />
                                    <strong>Fireplace: </strong>Gas,Living Room<br />
                                    <strong>Pool: </strong>None<br />
                                    <strong>Park: </strong>Community Garage,Door Opener,Garage,Subterranean,Tandem<br />
                                    <strong>View Type: </strong>City Lights<br />
                            ...
                            <div class="col-lg-6">
                                <p>
                                    ...
                                    <strong>Type: </strong>Condominium,Low Rise<br />
