            	...
            	<div class="single-list">
                	<div class="row" style="border-bottom:1px solid #eeeeee;">
                    	<div class="col-lg-6 left">
                        	<h1>Saltair Ave, <br />Los Angeles 90049 </h1>
                        </div>
                    ...
                    <div id="gallery">
                        <div id="panel">
                            <img id="largeImage1" src="../img/properties/saltair/download (5).jpeg" />
                                ...
                                <div id="feature-carousellist1" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (1).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (2).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (3).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (4).jpeg" width="300" alt="">
                                                </li>
                                            </ul>           
                                        </div>
                                        <div class="item">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (5).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                   <img src="../img/properties/saltair/download (6).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download (7).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/saltair/download.jpeg" width="300" alt="">
                                                </li>
                                            </ul>             
                                        </div>  
                    ...
                    <div class="remarks">
                        <div class="row">
                            <div class="col-lg-12">
                                <p><strong>Property: </strong>3 br, 2.75 ba, 2,451ft²</p>
                                <p><strong>Remarks: </strong>1ST OFFERING IN 46 YRS. CHARMING 1 STY CALIFORNIA RANCH ON LG FLAT LOT IN HEART OF BW. PRISTINE CONDITION, BROAD FRONTAGE, HUGE GRASSY YARD. LR W/ FP & DINING AREA OPEN OUT TO PATIO & PVT GARDEN. SUNNY, EAT-IN KITCH. 3 BR'S, 2.75 BA & COZY DEN W/ CNR FP. SPACIOUS RMS, CROWN MLDGS, HARDWD FLRS (UNDER CARPETING) & PLANTATION SHUTTERS. DIRECT ACCESS GARAGE. A STONE'S THROW FROM SHOPS & RESTAURANTS ON SAN VICENTE.
                                </p>	
                        ...
                        <div class="row">
                        	<div class="col-lg-6">
                                <p>
                                    <strong>Rooms: </strong>Breakfast Area,Den,Dining Area,Living,Patio Open,Service Entrance<br />
                                    <strong>Amenities: </strong><br />
                                    <strong>Equip: </strong>Built-Ins,Cable,Dishwasher,Garbage Disposal,Hood Fan,Range/Oven<br />
                                    <strong>Air: </strong>None<br />
                                    <strong>Floor: </strong>Carpet,Hardwood,Tile<br />
                                    <strong>Fireplace: </strong>Den,Living Room<br />
                                    <strong>Pool: </strong>None<br />
                                    <strong>Park: </strong>Attached<br />
                                    <strong>View Type: </strong>None<br />
