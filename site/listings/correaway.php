            	...
            	<div class="single-list">
                	<div class="row" style="border-bottom:1px solid #eeeeee;">
                    	<div class="col-lg-6 left">
                        	<h1>Correa Way, <br />Los Angeles 90049 </h1>
                        </div>
                    ...
                    <div id="gallery">
                        <div id="panel">
                            <img id="largeImage1" src="../img/properties/correaway/download (1).jpeg" />
                            ...
                            <div class="row">                                 
                                <div id="feature-carousellist1" class="carousel slide">
                                    ...
                                    <ol class="carousel-indicators">
                                        ...
                                        <li data-target="#feature-carousellist1" data-slide-to="2"></li> 
                                        <li data-target="#feature-carousellist1" data-slide-to="3"></li>  
                                        <li data-target="#feature-carousellist1" data-slide-to="4"></li>  
                                        <li data-target="#feature-carousellist1" data-slide-to="5"></li>     
                                     </ol>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download.jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (1).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (2).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (3).jpeg" width="300" alt="">
                                                </li>
                                            </ul>           
                                        </div>
                                        <div class="item">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (4).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                   <img src="../img/properties/correaway/download (5).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (6).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (7).jpeg" width="300" alt="">
                                                </li>
                                            </ul>             
                                        </div>  
                                        <div class="item">
                                            <ul class="col-lg-12">
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (8).jpeg" width="300" alt="">
                                                </li>
                                                <li class="col-lg-3">
                                                    <img src="../img/properties/correaway/download (9).jpeg" width="300" alt="">
                                                </li>
                    ...
                    <div class="remarks">
                        <div class="row">
                            <div class="col-lg-12">
                                <p><strong>Property: </strong>5 br, 7.5 ba, 5,804ft²</p>
                                <p><strong>Remarks: </strong>Perfectly situated behind electric gates in the hills of Brentwood, this 5 bedroom, 7.5 bathroom Zen Contemporary-style estate is strategically positioned to take advantage of the sweeping panoramic views that span from the snow peak of Mt. Baldy to downtown Los Angeles, Catalina Island and along the glistening Southern California coastline. There is a resort-style backyard that features a large grassy area and a free-form rock pool, spa and waterfall. In addition to the custom built home, the compound boasts a second residential structure which adds to the unique quality and overall appeal of the property.
                                </p>	
                        ...
                        <div class="row">
                        	<div class="col-lg-6">
                                <p>
                                    <strong>Rooms: </strong>Breakfast Area,Dining Area,Family,Living,Patio Open,Powder,Service Entrance<br />
                                    <strong>Amenities: </strong><br />
                                    <strong>Equip: </strong>Built-Ins,Dishwasher,Garbage Disposal,Hood Fan,Microwave,Range/Oven,Refrigerator<br />
                                    <strong>Air: </strong>Central,Multi/Zone<br />
                                    <strong>Floor: </strong>Hardwood<br />
                                    <strong>Fireplace: </strong>Living Room,Master Bedroom<br />
                                    <strong>Pool: </strong>Heated,Private,Solar Heat<br />
                                    <strong>Park: </strong>Detached<br />
                                    <strong>View Type: </strong>City Lights,Ocean<br />
                                    <strong>Security: </strong>Gated,Owned,T.V.<br />
                                    <strong>Sewer: </strong>In Street<br />
                            ...
                            <div class="col-lg-6">
                                <p>
                                    ...
                                    <strong>Laundry: </strong>Room<br />
                                    <strong>Roof: </strong>Other<br />
                                    <strong>Type: </strong><br />
                                    <strong>Tennis: </strong><br />
                                    <strong>Spa: </strong>Private<br />
